...
class CarAdapter(
    ...
    private val activity: FragmentActivity // Accept the FragmentActivity
    ...
    override fun onBindViewHolder(holder: CarViewHolder, position: Int) {
        ...
        // Configurar el botón View More
        holder.viewMoreButton.setOnClickListener {
            // Crear y mostrar el diálogo con los detalles del carro
            val dialog = CarDetailDialogFragment(car)
            dialog.show(activity.supportFragmentManager, "CarDetailDialog") // Use activity.supportFragmentManager
        }
    }
